...
\textbf{\checked C:} Red, Yellow, White \newline  
...
\end{tabular} &
\begin{tabular}{p{10.5cm}}
\textbf{\checked A:} Only 1 pair \newline 
\textbf{\unchecked B:} 2 pairs \newline  
\textbf{\unchecked C:} 3 pairs \newline  
\textbf{\unchecked D:} All 4 pairs \newline  
\end{tabular} \\ \bottomrule
\end{tabular}
...
\textbf{\checked C:} Multiply x by -1 and add 255 \newline  
...
\begin{tabular}{|p{8cm}@{\hskip 0.5cm}p{10.5cm}|} 
\toprule  
\textbf{Question 4} & \emph{Lecture 1 \hfill Histograms and color}  \\
\midrule 
\begin{tabular}{p{8cm}} Open question: For this 3x4 intensity image and its pixel values. \newline\includegraphics[width=7cm,height=6cm,keepaspectratio]{l4_q1_o.png} \newline\newline Draw its histogram and apply histogram equalization. Give all the performed steps. 
\end{tabular} &
\begin{tabular}{p{10.5cm}}
\textbf{Rubric:} \newline 
